...
int					validate_philosopher_count(char **arg);
int					validate_must_eat_count(char **arg);
int					validate_timing_args(char **arg);
int					validate_time_to_die(char **arg);
int					validate_eat_time(char **arg);
int					validate_sleep_time(char **arg);
